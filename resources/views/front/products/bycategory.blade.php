    ...
    <div class="breadcrumb_section bg_gray page-title-mini">
        <div class="container"><!-- STRART CONTAINER -->
            <div class="row align-items-center mb-3">
                <div class="col-md-12">
                    <ol class="breadcrumb justify-content-md-left">
                        <li class="breadcrumb-item"><a href="{{ route('home.index') }}">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('products.index') }}">Colecciones</a></li>
                        <li class="breadcrumb-item active">
                            {{ $selectedCat->nombre_seo ?? '' }}
                        </li>
                    </ol>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-md-10">
                    <div class="page-title">
                        ...
                        <p>{!! $selectedCat->descripcion ?? '' !!}</p>
                    </div>
                </div>     
                <div class="col-md-2">
                    <img class="img-fluid" src="{{ asset('front/assets/images/categorias/'.$selectedCat->imagen ) }}">
                </div>                       
            </div>
        </div><!-- END CONTAINER-->
    </div>
        ...
        <div class="row">
                <div class="col-lg-3 order-lg-first mt-4 pt-2 mt-lg-0 pt-lg-0">
                    <div class="sidebar">
                        ...
                        <div class="widget">
                            <h5 class="widget_title">Filtrar</h5>
                         ...
                         <div class="widget">
                            ...
                            <ul class="widget_categories">
                                @foreach ($coleccion_mujer as $colMujer)
                                    <li>
                                        <a href="{{ route('products.byCategory', [$colMujer->tipo?->p_cat_slug ?? 'mujer', $colMujer->slug]) }}">
                        ...
                        <div class="widget">
                            <div class="shop_banner">
                                <div class="banner_img overlay_bg_20">
                                    <img src="{{ asset('front/assets/images/sidebar_banner_prod.png') }}"
