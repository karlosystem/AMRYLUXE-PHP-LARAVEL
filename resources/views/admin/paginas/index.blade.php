            ...
            <div class="col-md-12">
                <div class="customers__area bg-style mb-30">
                    ...
                    <div class="item-title">
                        <div class="col-xs-6">
                            <a href="{{ route('admin.paginas.create') }}" class="btn btn-md btn-info">Agregar Pagina</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($paginas as $data)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                @if ($data->imagen)
                                                    <img src="{{ asset('front/assets/images/paginas/' . $data->imagen) }}"
                                                        alt="{{ $data->titulo }}"
                                            ...
                                            <td>
                                                ...
                                                <div class="action__buttons">
                                                    <a href="{{ route('admin.paginas.edit', $data->id) }}"
                                                        class="btn-action">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="#" class="btn-action">
                                                        <form action="{{ route('admin.paginas.destroy', $data->id) }}"
