            ...
            <div class="col-md-12">
                <div class="customers__area bg-style mb-30">
                     <div class="item-title">
                            <div class="col-xs-6">
                                <a href="{{ route('admin.testimonio.create') }}"
                                    class="btn btn-md btn-info">Agregar Testimonio</a>
                            </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($testimonios as $data)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                @if($data->imagen)
                                                    <img src="{{ asset('front/assets/images/testimonios/' . $data->imagen) }}" 
                                                        alt="{{ $data->nombre }}" 
                                            ...
                                            <td>                                            
                                                <div class="action__buttons">
                                                    <a href="{{ route('admin.testimonio.edit', $data->id) }}" class="btn-action">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="#" class="btn-action">
                                                        <form action="{{ route('admin.testimonio.destroy', $data->id) }}"
